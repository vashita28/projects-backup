...
public class RecipientsActivity extends ListActivity {
								...
								if (e == null)
								{
									...
									for (ParseUser friend : mOtherFriends) {
										...
										{	
											...
											HashSet<ParseUser> listWithoutDuplicates = new HashSet<ParseUser>(mFriendsFound);
											
											mFriendsFinal = new ArrayList<ParseUser>(listWithoutDuplicates);
											
											String[] usernames = new String[mFriendsFinal.size()];
											int i = 0;
	...
	protected ParseObject createMessage() {
		...
		if (mFileType.equals(ParseConstants.TYPE_IMAGE)) {
			...
			String filePathVideo = Environment.getExternalStorageDirectory() + File.separator + "VID_.3gp";
		...
		message.saveInBackground(new SaveCallback() {
			...
			public void done(ParseException e) {
				...
				if (e == null) {
					...
					String alertMessage = ParseUser.getCurrentUser().getUsername() + " sent you a snap " + mFileType + "!";
					...
					try {
                    	...
                    	push.setChannels(getRecipientNames()); // Notice we use setChannels not setChannel
                    	push.setData(data);
                    	push.sendInBackground();
                    	
                    } catch (Exception e1) {
						Log.e("eee", e1.toString());
				    }
