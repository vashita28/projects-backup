...
import com.coudriet.tapsnap.adapters.SectionsPagerAdapter;
...
public class MainActivity extends FragmentActivity implements
	...
	public void broadcastIntent(View view) {
		...
		intent.setAction("com.coudriet.tapsnap.android.CUSTOM_INTENT");
		sendBroadcast(intent);
		// Log.e(TAG, "UPDATE_LIST");
		// Intent intent1 = new Intent();
		// intent1.setAction("com.coudriet.tapsnap.android.UPDATE_LIST");
	...
	protected void onPause() {
		Log.d(getClass().getSimpleName(), "On onPause");
	...
	protected void onResume() {
		...
		try {
			mNotificationManager = (NotificationManager) getSystemService(PushService.NOTIFICATION_SERVICE);
		} catch (Exception ex) {
