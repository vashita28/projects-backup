	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		rlRegister.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				editor.putString(ParseConstants.KEY_LOGIN_VIA_FACEBOOK, "false");
				editor.commit();
		...
		ParseFacebookUtils.logIn(permissions, this, new LogInCallback() {
			...
			public void done(ParseUser user, ParseException err) {
				...
				if (user == null) {
					...
					Log.v(TAG, "User value: new user");
					Editor editor = sharedpreferences.edit();
					editor.putBoolean(ParseConstants.KEY_LOGIN_VIA_FACEBOOK, true);
					editor.commit();
					if (AppStatus.getInstance(SignUpActivity.this).isOnline()) {
									...
									if (user != null) {
										...
										try {
											...
											if (mCurrentUser != null) {
												...
												// Username
												mCurrentUser.setUsername(user
														.getName());
												// Password
												mCurrentUser.setPassword("");
												// Email
												mCurrentUser.setEmail(user
														.asMap().get("email")
														.toString());
					...
					newUser.signUpInBackground(new SignUpCallback() {
						...
						public void done(ParseException e) {
							...
							if (e == null) {
								...
								String msg = getString(R.string.user_already);
								String tit = getString(R.string.signup_error_title);
