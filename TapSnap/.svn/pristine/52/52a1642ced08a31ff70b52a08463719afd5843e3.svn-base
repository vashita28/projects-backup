...
import com.coudriet.snapnshare.adapters.RequestsAdapter;
...
public class RequestsFragment extends ListFragment {
	...
	private ProgressBar pbInFriendsReq;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		pbInFriendsReq = (ProgressBar) rootView
	...
	private void updateRequestsList() {
		...
		pbInFriendsReq.setVisibility(View.VISIBLE);
		// getActivity().setProgressBarIndeterminateVisibility(true);
		getListView().setEnabled(false);

		ParseQuery<ParseObject> query = new ParseQuery<ParseObject>(
				ParseConstants.CLASS_REQUESTS);
		query.whereEqualTo(ParseConstants.KEY_RECIPIENT_ID, ParseUser
		...
		if (currentUser == null) {
			...
			query.findInBackground(new FindCallback<ParseObject>() {
				...
				public void done(List<ParseObject> requests, ParseException e) {
					...
					pbInFriendsReq.setVisibility(View.INVISIBLE);
					if (mContext != null)
