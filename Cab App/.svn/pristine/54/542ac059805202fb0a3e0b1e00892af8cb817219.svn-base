...
public class FetchJobs {
	...
	public JobsList getJobsList(boolean bIsPreBook, Context context, Location currentDriverLocation) {
		...
		if (!bIsPreBook) {
			...
			if (currentLocation != null) {
				...
				Log.e("FetchJobs", "getJobsList :: current Location :: lat = " + lat + " long = " + lng);

				nameValuePairs.add(new BasicNameValuePair("data[latitude]", lat));
				nameValuePairs.add(new BasicNameValuePair("data[longitude]", lng));
			}
