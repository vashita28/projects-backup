...
public class Connection {
	...
	public void connect(int type) {
		...
		case Constants.MPOS_CHIP_AND_PIN_PAYMENT:
			String MPosChipAndPinURL = Constants.driverURL
					+ "mpospayment?accessToken=" + Constants.accessToken;
			postRequest(MPosChipAndPinURL);
			break;

		case Constants.MPOS_SEND_RECEIPT:
			String MPosSendReceiptURL = Constants.driverURL
					+ "mposreceipt?accessToken=" + Constants.accessToken;
			postRequest(MPosSendReceiptURL);
			break;

		case Constants.PAYMENT_URL_TO_PASSENGER:
			String paymentUrlForPassengerURL = Constants.driverURL
					+ "payment/sendpaymenturl?accessToken="
					+ Constants.accessToken;
		...
		case Constants.CHECK_STATUS_OF_PAYMENT_URL_TO_PASSENGER:
			...
			String paymentstatusURL = Constants.driverURL
					+ "isurlpaid?bookingId=" + jobId;
