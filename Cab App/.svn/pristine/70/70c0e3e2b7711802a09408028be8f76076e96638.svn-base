...
public class ChipAndPinTask extends AsyncTask<String, Void, String> {
	...
	protected String doInBackground(String... params) {
		...
		nameValuePairs.add(new BasicNameValuePair("data[totalAmount]", String
				.valueOf(szTotalValue)));
		nameValuePairs.add(new BasicNameValuePair("data[fee]", String
				.valueOf(szCardFees)));
		...
		nameValuePairs.add(new BasicNameValuePair("data[merchantRefNum]",
				"driver" + Util.getDriverID(mContext) + "-"
						+ System.currentTimeMillis()));
		nameValuePairs.add(new BasicNameValuePair("data[currencyCode]",
				transactionResult.getCurrency().toString()));
		nameValuePairs.add(new BasicNameValuePair("data[transactionID]",
				transactionResult.getTransactionID()));
		nameValuePairs.add(new BasicNameValuePair("data[financialStatus]",
				transactionResult.getFinStatus().toString()));

		nameValuePairs.add(new BasicNameValuePair("data[cardEntryType]",
				transactionResult.getCardEntryType().toString()));
		nameValuePairs.add(new BasicNameValuePair("data[cardSchemeName]",
				transactionResult.getCardSchemeName()));
		nameValuePairs.add(new BasicNameValuePair("data[CVM]",
				transactionResult.getOriginalEFTTransactionID()));

		nameValuePairs.add(new BasicNameValuePair("data[authorisationCode]",
				transactionResult.getAuthorisationCode()));
		nameValuePairs.add(new BasicNameValuePair("data[EFTTimestamp]",
				transactionResult.geteFTTimestamp().toString()));
		nameValuePairs.add(new BasicNameValuePair("data[ApplicationName]",
				transactionResult.getDeviceStatus().getApplicationName()));

		nameValuePairs.add(new BasicNameValuePair("data[ApplicationVersion]",
				transactionResult.getDeviceStatus().getApplicationVersion()));
		nameValuePairs.add(new BasicNameValuePair("data[BatteryStatus]",
				transactionResult.getDeviceStatus().getBatteryStatus()));
		nameValuePairs.add(new BasicNameValuePair("data[cardNumber]",
				szCardNumber));
		nameValuePairs.add(new BasicNameValuePair("data[receipt]",
				transactionResult.getCustomerReceipt()));
