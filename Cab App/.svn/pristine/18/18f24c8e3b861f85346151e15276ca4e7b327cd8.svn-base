...
public class BuyCreditsConfirmActivity extends RootActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mBundle != null) {
			...
			textPaymentMethod.setText(mBundle.getString(Constants.BUYCREDITS_CARD_BRAND) + "-"
					+ mBundle.getString(Constants.BUYCREDITS_CARD_TRUNCATEDPAN));
	...
	void ConfirmButtonCall() {
		...
		tvCreditAdded.setText("You have added " + nNoOfCredits + " credits to your account.");
