...
public class PaymentWithURL {
	...
	Context mContext;
	String meterAmount, tip, cardFees, totalAmount, cabMiles, szJobId = "",
			sType = "", sMobileNumber = "", sInternationalcode = "",
			sEmail = "", sPickUpAdd = "", sDropOffAdd = "";
	boolean isWalkUp = false;

	public PaymentWithURL(Context context, String meterAmt, String tip,
			String cardFees, String totalAmount, String jobID,
			String sReceiptType, String sMobileNo, String sInternationalNo,
			String sEmail, String sPickUp, String sDropOff) {
	...
	public String SendPaymentUrlToCustomer() {
		...
		if (sType.equals("sms")) {
			...
			nameValuePairs.add(new BasicNameValuePair(
					"data[internationalCode]", sInternationalcode));
			...
			try {
				{
					...
					Log.e("PaymentWithURL", "PaymentWithURLResponse "
							+ paymentResponse);
