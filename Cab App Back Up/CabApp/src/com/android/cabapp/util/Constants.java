...
<<<<<<< .mine
	public static final String driverURL = "http://54.154.107.136//ws/v2/driver/";
	public static final String passengerURL = "http://cabapp.pocketapp.co.uk/ws/v2/passenger/";
	public static final String cityURL = "http://cabapp.pocketapp.co.uk/ws/v2/city/list";
	public static final String promotionURL = "http://cabapp.pocketapp.co.uk/promotion";
=======
	// public static final String driverURL =
	// "http://cabapp.pocketapp.co.uk/ws/v2/driver/";
>>>>>>> .r450

	public static final String driverURL = "http://prod.api.cabapp.pocketapp.co.uk/ws/v2/driver/";
	public static final String passengerURL = "http://prod.api.cabapp.pocketapp.co.uk/ws/v2/passenger/";
	public static final String cityURL = "http://prod.api.cabapp.pocketapp.co.uk/ws/v2/city/list";
	public static final String promotionURL = "http://prod.api.cabapp.pocketapp.co.uk/promotion";
	public static final String sectorURL = "http://prod.api.cabapp.pocketapp.co.uk/ws/v2/city/sectorslist?cityId=1";
