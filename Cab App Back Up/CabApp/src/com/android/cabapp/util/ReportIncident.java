...
public class ReportIncident {
	...
	public String httpPostReportIncident(String argUrl, File file1, File file2,
			File file3, File file4, File file5, File videoFile,
			String incidentText) throws Exception {

		urlServer = Constants.driverURL + "reportincident/?accessToken="
		...
		if (file1 != null) {
			...
			Log.e("ReportIncident-httpPostSendFile()",
		...
		if (file3 != null) {
			...
			Log.e("ReportIncident-httpPostSendFile()",
					"File 3:: " + file3.getName());
		}

		if (file4 != null) {
			fileBody4 = new FileBody(file4);
			Log.e("ReportIncident-httpPostSendFile()",
					"File 4:: " + file4.getName());
		}

		if (file5 != null) {
			fileBody5 = new FileBody(file5);
			Log.e("ReportIncident-httpPostSendFile()",
					"File 5:: " + file5.getName());
		}
		if (videoFile != null) {
			videoFileBody = new FileBody(videoFile);
			Log.e("ReportIncident-httpPostSendFile()", "VideoFile:: "
					+ videoFile.getName());
		}
