...
public class SendReceipt {
	...
	public SendReceipt(Context context, String szMobileNumber,
			String szInternationalCode, String szPickUp, String szDropOff,
			String szEmail, String szSendingMode, String amount,
			String paymentType, String tip) {
	...
	public SendReceipt(Context context, String jobID, String fees,
			String sendingType, String amount, String tip, String email,
			String mobileNumber) {
		// TODO Auto-generated constructor stub
		mContext = context;
		connection = new Connection(mContext);
