...
public class NumberPicker extends LinearLayout implements OnClickListener,
	...
	public void onClick(View v) {
		...
		if (R.id.increment == v.getId()) {
			...
			if (mHandlerRoomOccupanyDetailsUIUpdate != null)
				mHandlerRoomOccupanyDetailsUIUpdate
						.sendEmptyMessage(Const.INCREMENT);
			...
			if (mHandlerRoomOccupanyDetailsUIUpdate != null)
				mHandlerRoomOccupanyDetailsUIUpdate
						.sendEmptyMessage(Const.DECREMENT);
	...
	private void showDialog(int id, int value) {
		MyDialogFragment dialogFragment = MyDialogFragment.newInstance(id,
				value);
	...
	public void setTextViewForUpdation(TextView totalRateText, String currency,
			float roomRate) {
	...
	protected void updateView() {
		...
		if (totalRateText != null) {
			totalRateText.setText(Html.fromHtml(String.format(text, currency,
					String.valueOf(mCurrent * roomRate))));
		}
	}
	...
	public void setCallBackAfterNumberChange(Handler handler,
			CurrentValueForRoomOccupancy currentRoomsRequired) {
		this.mHandlerFindHotelUIUpdate = handler;
		this.currentRoomsRequired = currentRoomsRequired;
	}

	public void setCallBackAfterNumberChangeRoomOccupancyDetails(
			Handler handler,
	...
	public void setCallBackAfterNumberOfChildChange(Handler handler,
			CurrentValueForChildCount currentChildCount) {
