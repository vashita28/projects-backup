...
public class EventOverviewFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		txt_eventdetails.setTypeface(Typeface.createFromAsset(getActivity().getAssets(),
			    "ROBOTO-LIGHT.TTF"));
	...
	public void onGetDataFromDB() {
		try {
			...
			txt_eventdate.setText(LLDCApplication.selectedModel.getActiveDays()
					.toString().toUpperCase());
//			txt_eventdetails.setText(Html.fromHtml("<body>" + LLDCApplication.selectedModel.getLongDescription() + "</body>"));
//			txt_eventdetails.loadDataWithBaseURL(null, LLDCApplication.selectedModel.getLongDescription(), "text/html", "utf-8", null);
			txt_eventdetails.setHtmlFromString(LLDCApplication.selectedModel.getLongDescription(), false);
	...
	public void onOpenAddCalEventDialog() {
		try {
			...
			AlertDialog.Builder quitAlertDialog = new AlertDialog.Builder(getActivity());
			...
			quitAlertDialog.setTitle("Event")
...
//										"QEOP::"
										...
										values.put(Events.TITLE,
												"QEOP::" + LLDCApplication.selectedModel
														.getName());
...
//										onAddCalendarEvent();
										...
										LLDCApplication.onShowLogCat("EVENT_URI", uri.toString() +"");
...
//					null);
			...
			for (int i = 0; i < CNames.length; i++) {
				LLDCApplication.onShowLogCat("EVENT_URI", cursor.getString(0).toString() +"");
	...
	public void onAddCalendarEvent(){
         ...
         event.put(CalendarContract.Events.CALENDAR_ID, LLDCApplication.selectedModel.get_id());
         event.put(CalendarContract.Events.TITLE, LLDCApplication.selectedModel.getName());
         event.put(CalendarContract.Events.DESCRIPTION, LLDCApplication.selectedModel.getShortDesc());
//         event.put(CalendarContract.Events.EVENT_LOCATION, appointment.mAddress);

         event.put(CalendarContract.Events.DTSTART, LLDCApplication.selectedModel.getStartDateTime()+"000");
         event.put(CalendarContract.Events.DTEND, LLDCApplication.selectedModel.getEndDateTime()+"000");
         ...
         event.put(CalendarContract.Events.EVENT_TIMEZONE, TimeZone
					.getDefault().getID()); 
         Uri url = getActivity().getContentResolver().insert(CalendarContract.Events.CONTENT_URI, event);
