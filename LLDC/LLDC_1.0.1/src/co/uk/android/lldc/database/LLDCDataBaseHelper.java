...
public class LLDCDataBaseHelper extends SQLiteOpenHelper {
	...
	public ArrayList<ServerModel> onSearchResultFacility(String where,
		...
		String query = "select b.* from (select DISTINCT " + COLUMN_ID + "," + COLUMN_MODEL_TYPE
				+ " from " + TABLE_VENUE_FACILITIES + " where "
				+ COLUMN_FACILITY_ID + " in ('" + where + "')) as a, "
				+ tableName + " b where a." + COLUMN_ID + " = b." + COLUMN_ID
				+ " AND a." + COLUMN_MODEL_TYPE + " = b." + COLUMN_MODEL_TYPE
				+ ";";
