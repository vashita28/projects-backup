...
public class LLDCApplication extends Application {
	...
	public void onCreate() {
		...
		DisplayImageOptions defaultOptions = new DisplayImageOptions.Builder()
				.cacheInMemory(true)
				.cacheOnDisk(true)
				.showImageOnFail(R.drawable.imgnt_placeholder)
				.showImageOnLoading(R.drawable.imga_placeholder)
		...
		ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(
				...
				.diskCacheExtraOptions(400, 480, null)
	...
	public static final String VERSION = "v 0.5.7";
