...
public class MediaDialogFragment extends DialogFragment {
	...
	public MediaDialogFragment(ArrayList<EventMediaModel> eventMediaList, ArrayList<MediaModel> mediaList, String pagetTitle, int position) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		adapter = new GalleryAdapter(getActivity(), mediaList, evetnmediaList, pageTitle);
