...
public class RecommendationExploreDetailsFragment extends Fragment {
	private static final String TAG = RecommendationExploreDetailsFragment.class
			.getSimpleName();
	...
	public Handler mRecommExploreDetailsFragHandler = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mRecommExploreDetailsFragHandler = new Handler() {
			public void handleMessage(Message message) {
				...
				if (message.what == 1101) {
					try {
						...
						mRecommExploreDetailsFragHandler
								.sendEmptyMessageDelayed(1101, 300000);
					} catch (Exception e) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		View rootView = null;
		Log.e(TAG, "Device is Tablet...RecommendationExploreDetailsFragment");
		...
		if (LLDCApplication.selectedModel.getModelType() == LLDCApplication.TRAILS) {
			tvStartTheTrail.setVisibility(View.VISIBLE);
			mRecommExploreDetailsFragHandler.sendEmptyMessageDelayed(1101,
					300000);
		} else {
			tvStartTheTrail.setVisibility(View.GONE);
		}
	...
	public void onDestroy() {
		...
		super.onDestroy();
		try {
			mRecommExploreDetailsFragHandler.removeMessages(1101);
			mRecommExploreDetailsFragHandler = null;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
