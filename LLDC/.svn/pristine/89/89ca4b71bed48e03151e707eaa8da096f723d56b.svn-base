	...
	class OnitemClickListener implements OnClickListener {
		...
		public void onClick(View v) {
					...
					if (mHomeActivityHandler != null) {
						if (!isMenuActivityCalled) {
							LLDCApplication
									.showSimpleProgressDialog(HomeActivity.this);
							isMenuActivityCalled = true;
							mHomeActivityHandler.sendEmptyMessageDelayed(1100,
									100);
							intent = new Intent(HomeActivity.this,
			...
			case R.id.rlRelaxTab:
				try {
					LLDCApplication.showSimpleProgressDialog(HomeActivity.this);
