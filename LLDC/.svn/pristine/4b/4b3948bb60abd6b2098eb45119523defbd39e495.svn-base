...
public class Search_ExploreDetailsFragment extends Fragment {
	private static final String TAG = Search_ExploreDetailsFragment.class
			.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(
				R.layout.search_fragment_exploredetails_tablet, container,
				false);
		...
		img_imagedetls = (ImageView) rootView
		...
		((SearchMapActivity) getActivity()).tvPageTitle.setText(pageTitle);
