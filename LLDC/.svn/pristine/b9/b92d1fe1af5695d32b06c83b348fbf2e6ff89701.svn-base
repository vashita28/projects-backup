...
public class VenueEventListAdapter extends BaseAdapter {
	private static final String TAG = VenueEventListAdapter.class
			.getSimpleName();
	...
	public View getView(int arg0, View convertView, ViewGroup arg2) {
		...
		try {
			int screenWidth = LLDCApplication.screenWidth / 5;
			String szImageUrl = "";
		...
		try {
			...
			vholder.eventName.setText(eventList.get(arg0).getName()
					.toUpperCase());
			vholder.eventDesc.setText(Html.fromHtml(eventList.get(arg0)
					.getShortDesc()));
