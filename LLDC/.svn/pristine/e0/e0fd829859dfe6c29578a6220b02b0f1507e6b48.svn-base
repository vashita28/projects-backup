...
public class TodaysEventActivity extends FragmentActivity {
	Context mContext;
	...
	protected void onCreate(Bundle arg0) {
		...
		hideFooterData();
		tvHeaderTitle.setText("Today's Event");
		displayView(1);
	}
	...
	class OnitemClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.relMenu:
				TodaysEventActivity.this.finish();
				break;

			case R.id.relSearch:
				try {
					LLDCApplication.showSimpleProgressDialog(TodaysEventActivity.this);
					intent = new Intent(TodaysEventActivity.this,
			...
			case R.id.rlRelaxTab:
				try {
					...
					TodaysEventActivity.this.startActivity(intent);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
