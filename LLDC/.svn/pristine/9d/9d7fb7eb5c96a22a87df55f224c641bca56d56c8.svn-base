...
public class Search_EventOverviewFragment extends Fragment {
	private static final String TAG = Search_EventOverviewFragment.class
			.getSimpleName();
	...
	public Search_EventOverviewFragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.eventdetails_overview_tablet,
				container, false);
		...
		((SearchMapActivity) getActivity()).tvPageTitle.setText("Events");
	...
	public void onResume() {
		...
		if (bEventAdded) {
			if (mEventOverviewHandler != null)
				mEventOverviewHandler.sendEmptyMessageDelayed(1010, 500);
			bEventAdded = false;
		}
	...
	// private Uri getCalendarURI(eventUri boolean){
	// Uri calendarURI = null;
	//
	// if (android.os.Build.VERSION.SDK_INT <= 7 )
	// {
	// calendarURI =
	// (eventUri)?Uri.parse("content://calendar/events"):Uri.parse("content://calendar/calendars");
	// }
	// else
	// {
	// calendarURI =
