...
public class RoundImageView extends ImageView {
     ...
     * {@link RoundImageView#setDefaultImageResId(int)} on the view.
     *
     * NOTE: If applicable, {@link RoundImageView#setDefaultImageResId(int)} and
     * {@link RoundImageView#setErrorImageResId(int)} should be called prior to calling
     * this function.
     *
