...
public class Search_MapFragment extends Fragment implements OnClickListener {
	private static final String TAG = Search_MapFragment.class.getSimpleName();
	...
	public Search_MapFragment(String pageSubTitle, String selectedId) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.search_map_fragment_tablet,
				container, false);
	...
	private void displayFragment(int position) {
		...
		switch (position) {
		case 1:
			fragment = (Fragment) new Search_VenueFragmentTablet();// VenueFragmentTablet
			...
			if (fragment != null) {
				...
				fragmentTransaction
						.addToBackStack(Search_MapFragment.class.getName())
						.add(R.id.frame_container, fragment,
								Search_VenueFragmentTablet.class.getName())
						// mFragmentManager
						// .beginTransaction()
						// .addToBackStack(Search_MapFragment.class.getName())
						// .add(R.id.frame_container, fragment,
