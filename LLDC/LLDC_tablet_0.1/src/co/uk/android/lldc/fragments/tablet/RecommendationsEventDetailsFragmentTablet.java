...
public class RecommendationsEventDetailsFragmentTablet extends Fragment {
	private static final String TAG = RecommendationsEventDetailsFragmentTablet.class
			.getSimpleName();
	...
	public Handler mRecommEventDetailsHandler = null;

	private static String[] CONTENT = new String[] { "Overview", "Social" };

	public RecommendationsEventDetailsFragmentTablet() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRecommEventDetailsHandler = new Handler() {
			public void handleMessage(Message message) {
				...
				if (message.what == 1101) {
					try {
						...
						mRecommEventDetailsHandler.sendEmptyMessageDelayed(
								1101, 300000);
					} catch (Exception e) {
	...
	public void onDestroy() {
		...
		super.onDestroy();
		try {
			mRecommEventDetailsHandler.removeMessages(1101);
			mRecommEventDetailsHandler = null;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
