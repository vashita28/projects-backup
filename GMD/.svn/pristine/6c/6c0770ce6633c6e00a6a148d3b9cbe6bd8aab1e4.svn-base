...
public class ReportDetailsXMLHandler extends DefaultHandler {
	...
	public void endElement(String uri, String name, String qName) {
		...
		else if (szCurrentTag.equals(XML_Values.CYCLO_CONVERTER))
