...
public class SC_Services_ThirdGen_Adapter extends CursorAdapter {
	...
	public SC_Services_ThirdGen_Adapter(Context argContext, Cursor argCursor,
	...
	public void bindView(View argView, Context arg1, Cursor argCursor) {
		...
		Cursor taskCursor = context.getContentResolver().query(
				...
				DataProvider.Tasks.MILL_ID + " = ?" + " AND "
						...
						+ " AND " + DataProvider.Tasks.SERVICES_PARENT_ID
		...
		} else if (nTaskCompletedCount == nTaskTotalCount)// AppValues.nleaf_child_in_each_thirdgen
			imageview_color.setBackgroundDrawable(arg1.getResources()
