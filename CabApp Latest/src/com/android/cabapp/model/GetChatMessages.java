...
public class GetChatMessages {
	...
	public Job getJobByJobID() throws JSONException {
		...
		if (connection.mInputStream != null) {
			try {
				{
					message = connection.inputStreamToString(connection.mInputStream).toString();
					...
					if (connection.mInputStream != null) {
						...
						job = gson.fromJson(jObject.getJSONObject("jobs").toString(), Job.class);
					}
