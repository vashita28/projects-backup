...
public class MposSendReceipt {
	...
	String szJobId = "", szSendingType = "", szMobileNumber = "", szInterCode = "", pickup = "", dropOff = "", email = "",
			szAmount = "0", szTip = "0", szFee = "0", szPaymentType = "", szTransactionID = "", szPaymentstatus = "",
			truncatedPan = "", brand = "", merchantId = "", terminalId = "", entryMode = "", AID = "", PWID = "",
			authorization = "",szmeterAmount="0";

	private String currency;

	private String currencyCode;

	public MposSendReceipt(Context context, String szMobileNumber, String szInternationalCode, String szPickUp, String szDropOff,
			String szEmail, String amount, String paymentType, String tip, String jobID, String fees, String sendingType,
			String szTransactionId, String szPaymentStatus, String szTruncatedPan, String szBrand, String szMerchantId,
			String szTerminalId, String szEntryMode, String szAID, String szPWID, String szAuthorization, String currency,
			String currencyCode,String szmeterAmount) {
		...
		this.szmeterAmount = szmeterAmount;
	}
	...
	public String mPosSendingReceipt() {
		...
		nameValuePairs.add(new BasicNameValuePair("data[truncatedPan]", truncatedPan));
		nameValuePairs.add(new BasicNameValuePair("data[brand]", brand));
		nameValuePairs.add(new BasicNameValuePair("data[merchantId]", merchantId));
		nameValuePairs.add(new BasicNameValuePair("data[terminalId]", terminalId));
		nameValuePairs.add(new BasicNameValuePair("data[entryMode]", entryMode));
		nameValuePairs.add(new BasicNameValuePair("data[AID]", AID));
		nameValuePairs.add(new BasicNameValuePair("data[PWID]", PWID));
		nameValuePairs.add(new BasicNameValuePair("data[authorization]", authorization));
		...
		nameValuePairs.add(new BasicNameValuePair("data[transationId]", szTransactionID));
		nameValuePairs.add(new BasicNameValuePair("data[paymentStatus]", szPaymentstatus));
		...
		nameValuePairs.add(new BasicNameValuePair("data[meterAmount]", szmeterAmount));
