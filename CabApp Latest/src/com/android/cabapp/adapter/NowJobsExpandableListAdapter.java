...
public class NowJobsExpandableListAdapter extends BaseExpandableListAdapter
	...
	class CalculateDistanceTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			Log.e("NowJobsExpandableListAdapter", "mapsURLPickupToDropOff client URL :: " + url);
			try {
			...
			Log.e("NowJobsExpandableListAdapter", "mapsURLPickupToDropOff signed URL :: " + url);
			...
			Log.e("NowJobsExpandableAdapter", "mapsURLUserToPickup client URL :: " + url);
			try {
				url = UrlSigner.getMapURL(url);
			} catch (InvalidKeyException e1) {
				// TODO Auto-generated catch block
			...
			Log.e("NowJobsExpandableAdapter", "mapsURLUserToPickup signed URL :: " + url);
