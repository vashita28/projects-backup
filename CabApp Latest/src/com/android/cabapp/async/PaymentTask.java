...
public class PaymentTask extends AsyncTask<String, Void, String> {
	...
	public String szFeesPaidBy = "", szCardPayworkToken = "", isRegisteredCard = "", szCardBrand = "", szTruncatedPan = "";
	...
	protected String doInBackground(String... arg0) {
		...
		if (jobId != null && !jobId.isEmpty()) {
			...
			jobPayment = new JobPayment(Util.mContext, jobId, totalAmount, tip, meterAmount, szFeesPaidBy, szCardPayworkToken,
					cardFees, isRegisteredCard, szCardBrand, cabmiles, isWalkUp, szTruncatedPan);
		} else {
			Log.e(TAG, "job id not present");
			jobPayment = new JobPayment(Util.mContext, totalAmount, tip, meterAmount, szFeesPaidBy, szCardPayworkToken, cardFees,
