...
public class SendReceiptTask extends AsyncTask<String, Void, String> {
	public String szJobID, szType, szAmount, szTip, szFee, szMobile, szInternationalCode, szPU, szDO, szEmail, szPaymentType,
	...
	protected String doInBackground(String... params) {
		...
		if (Constants.isDebug)
			Log.d("SendReceiptTask", "jobID:: " + szJobID + " szType: " + szType + " szAmount: " + szAmount + " szTip: " + szTip
					+ " szFee: " + szFee + " szMobile: " + szMobile + " szInternationalCode: " + szInternationalCode + " szPU: "
					+ szPU + " szDO: " + szDO + " szEmail: " + szEmail + " szPaymentType: " + szPaymentType + " currency :: "
		...
		if (szJobID != null && !szJobID.isEmpty()) {
			if (szTip != null && szTip.isEmpty())
				szTip = "0";
			sendReceipt = new SendReceipt(mContext, szJobID, szFee, szType, szAmount, szTip, szEmail, szMobile, currency,
					currencyCode);
		} else {
			if (szTip != null && szTip.isEmpty())
				szTip = "0";
			sendReceipt = new SendReceipt(mContext, szMobile, szInternationalCode, szPU, szDO, szEmail, szType, szAmount,
					szPaymentType, szTip, currency, currencyCode);
		}
