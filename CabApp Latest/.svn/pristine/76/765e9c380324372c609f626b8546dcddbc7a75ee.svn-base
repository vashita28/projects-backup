...
public class ChatActivity extends RootActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvSend.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (driverMessage.length() == 0 || driverMessage.trim().isEmpty()) {
	...
	void getMeOut() {
		Util.showToastMessage(ChatActivity.this, "Some error occured please try again later", Toast.LENGTH_LONG);
		Util.hideSoftKeyBoard(ChatActivity.this, ivBack);
		finishMe();
	}
