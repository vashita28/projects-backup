...
public class Constants {
	...
	public static final String DOMAINID = isProductionBuild ? "http://prod.api.cabapp.pocketapp.co.uk/"
			: "http://dev.api.cabapp.pocketapp.co.uk/";

	public static final String driverURL = DOMAINID + "ws/v2/driver/";
	public static final String passengerURL = DOMAINID + "ws/v2/passenger/";
	public static final String cityURL = DOMAINID + "ws/v2/city/list";
	public static final String promotionURL = DOMAINID + "promotion?accessToken=" + Util.getAccessToken(context);
	public static final String sectorURL = DOMAINID + "ws/v2/city/sectorslist?cityId=1";
	...
	public static final String VECHILE_LICENSE_NO = "vehicleLicenseNo";
	...
	public static final int POLLING_TIME = 30000;
	...
	/*
	 * All the push Notification type is mentioned here
	 */
	public static final String TYPE_MESSAGE_TO_DRIVER = "messagetodriver";
	public static final String TYPE_BOOKING_CANCELLED = "bookingcancelled";
	public static final String TYPE_NEW_BOOKINGS = "newbookings";
	public static final String TYPE_MESSAGE = "message";
	
	/*
	 * New constants declared by snagam
	 */
	public static final String CHECK_FOR_VECHICLE_LICENSE_NO = "EUR";
}
