...
public class DriverSettingDetails {
	private static final String TAG = DriverSettingDetails.class.getSimpleName();
	...
	public DriverSettings retriveDriverSettings(Context context) {
		...
		if (connection.mInputStream != null) {
			...
			if (driverSettings != null && driverSettings.getChipAndPin() != null) {
				String sChipAndPin = String.valueOf(driverSettings.getChipAndPin());
