...
public class CabAppServiceConnection {
	...
	public static ServiceConnection mConnection = new ServiceConnection() {
		public void onServiceConnected(ComponentName className, IBinder service) {
			Log.d("CabAppServiceConnection-onServiceConnected()", "S e r v i c e C o n n e c t e d");
			mBoundService = ((CabAppService.LocalBinder) service).getService();
		}

		public void onServiceDisconnected(ComponentName className) {
			Log.d("CabAppServiceConnection-onServiceDisconnected()", "S e r v i c e D i s c o n n e c t e d");
			mBoundService = null;
		}
	};
	...
	public static void startService(Activity startActivity) {
		...
		Log.d("CabAppServiceConnection-startService()", "S e r v i c e   s t a r t e d - " + startActivity.getClass().toString());
		startActivity.startService(intent);
		startActivity.bindService(intent, mConnection, Context.BIND_AUTO_CREATE);
	...
	public static void stopService(Activity startActivity) {
		...
		Log.d("CabAppServiceConnection-stopService()", "S e r v i c e   S t o p p e d");
	}

	public static void unBindService(Activity startActivity) {
		startActivity.unbindService(mConnection);
		Log.d("CabAppServiceConnection-unBindService()", "S e r v i c e   U n B i n d");
	}
