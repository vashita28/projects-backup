...
public class TutorialActivity extends RootActivity {
	...
	int position;
	Gallery gallery;
	ViewTutorialAdapter mViewTutorialAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mViewTutorialAdapter = new ViewTutorialAdapter(_context);
		gallery.setAdapter(mViewTutorialAdapter);
	...
	protected void onResume() {
		...
		mViewTutorialAdapter.notifyDataSetChanged();
	}
