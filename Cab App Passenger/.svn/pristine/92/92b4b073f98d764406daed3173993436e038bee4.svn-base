...
public class MyAccountParentFragment extends RootFragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		showSubfragments(0, "myAccountFragment");
	...
	public void showSubfragments(int position, String tagName) {
		...
		switch (position) {
		case 0:
			fragment = new com.example.cabapppassenger.fragments.MyAccountFragment();
			break;
