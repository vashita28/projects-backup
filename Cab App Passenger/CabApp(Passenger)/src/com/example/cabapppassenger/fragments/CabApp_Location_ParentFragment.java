...
public class CabApp_Location_ParentFragment extends RootFragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		showSubfragments(0, "cabapplocationFragment");
	...
	public void showSubfragments(int position, String tagName) {
		...
		switch (position) {
		case 0:
			fragment = new com.example.cabapppassenger.fragments.CabappLocation_fragment();
			break;
