...
public class HailNowParentFragment extends RootFragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		showSubfragments(0, "hailNowFragment");
	 ...
	 *            Details 4 -Chat Fragment 5- favorite fragment 6- recent
	 *            fragment
	 * 
	 * @param backStackName
	 */
	public void showSubfragments(int position, String tagName) {
		...
		switch (position) {
		case 0:
			fragment = new com.example.cabapppassenger.fragments.Hail_NowFragment();
			break;
		}
